package com.luffy.generalphotoflowlib.photoBrowse.controller;
...
import com.luffy.generalphotoflowlib.photoBrowse.ui.PhotoPagerActivity;
 ...
 *
 * @name
 * @desc 默认不开启保存图片功能，但是会有默认的保存图片地址,默认展示第一张图片<br>
...
public class PhotoBrowseConfig {
    ...
    private PhotoBrowseConfig(Activity activity, Builder builder) {
    ...
    public static class Builder {
        ...
        public PhotoBrowseConfig build() {
            return new PhotoBrowseConfig(context, this);
        }
    }
