...
import com.luffy.generalphotoflowlib.photoBrowse.controller.ToolBarHelper;
...
public class FrescoBaseActivity extends AppCompatActivity {
    ...
    /**
     * 1、从写此方法，如果{@link FrescoBaseActivity#openToolBar} is true,open toolBar<p>
    ...
    public void setOpenNavigationBar(boolean openNavigationBar) {
        this.openNavigationBar = openNavigationBar;
    }

    @TargetApi(21)
    public void setNavigationBarColor(@ColorRes int navigationBarColor) {
        getWindow().setNavigationBarColor(getResources().getColor(navigationBarColor));
    }
